...
var responsive = {
	...
	smallDetect : function() {
		...
		if (jQuery(".not-small").css("display") === "none" ) {
			isSmall = true;
			if(Modernizr.touch) {
	...
	mediumDetect : function() {
		...
		if (jQuery(".not-large").css("display") !== "none" &&  jQuery(".not-small").css("display") !== "none") {
			isMedium = true;
			if(Modernizr.touch) {
	 ...
	 largeDetect : function() {
		...
		if (jQuery(".is-large").css("display") !== "none" ) {
			isLarge = true;
			if(Modernizr.touch) {
				responsive.settings.isTablet = true;
			}
...
jQuery(window).load( function() {
	jQuery("body").append('<div class="not-small"></div><div class="not-large"></div><div class="is-large"></div>');
